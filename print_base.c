...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/18 23:34:09 by agusev            #+#    #+#             */
/*   Updated: 2019/04/19 01:00:11 by agusev           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ssl.h"

void	print_base_64(ssize_t newlen, char *base_64, int equ)
{
	int 	i;
	...
	while (i < newlen)
	{
		ft_printf("%c",alph[(int)(base_64[i])]);
		i++;
	}
	while (equ)
	{
...
void	base_64(char *input, size_t len)
{
	...
	print_base_64(newlen, res, equ);
}

void	print_dec_base_64(char *res, size_t len)
{
	size_t i;
